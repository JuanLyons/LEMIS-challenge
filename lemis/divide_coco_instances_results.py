...
def main(args):
    ...
    preds = load_json(preds_dir)
    annots = load_json(annots_dir)
    ...
    name2dataset = {
        image["file_name"]: dataset_name_dict[image["dataset"]]
    ...
    for key in tqdm(preds):
        file_name = key
        dataset_name = name2dataset[file_name]
        datasets_dict[dataset_name][key] = preds[key]
