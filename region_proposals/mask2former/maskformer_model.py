...
class MaskFormer(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        datasets = [batch_info["dataset"] for batch_info in batched_inputs]
        outputs = self.sem_seg_head(features, datasets)
    ...
    def instance_inference(self, mask_cls, mask_pred, mask_embd, decod_out):
        ...
        score_dist *= mask_scores_per_image.repeat(
            self.sem_seg_head.num_classes, 1
        ).permute(1, 0)
