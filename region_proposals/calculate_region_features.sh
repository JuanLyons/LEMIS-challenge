...
--config-file configs/endovis_2017/endovis_2017_SwinL_regions_train.yaml \
DATASETS.DATA_PATH data_1 \
OUTPUT_DIR outputs/LEMIS_endovis_2017_weights_subset_sar_rarp50_2/train_features \
