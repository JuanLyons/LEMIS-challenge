...
EXP_PREFIX="exp_LED_segmentation_4" # costumize
TASK="INSTRUMENTS"
ARCH="TAPIS"
...
COCO_ANN_PATH="./"$DATA"/"$DATASET"/annotations/grasp_"$TEST_FOLD".json"
...
CHECKPOINT="./"$DATA"/"$DATASET"/pretrained_models/best_LED.pyth"
...
ENDOVIS_DATASET.TRAIN_GT_BOX_JSON "grasp_"$TRAIN_FOLD".json" \
ENDOVIS_DATASET.TRAIN_PREDICT_BOX_JSON $TRAIN_FOLD"_train_preds.json" \
ENDOVIS_DATASET.TEST_GT_BOX_JSON "grasp_"$TEST_FOLD".json" \
