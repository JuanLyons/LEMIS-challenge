...
EXP_PREFIX="exp_original_LEMIS_fine-tuned_2" # costumize
TASK="INSTRUMENTS"
ARCH="TAPIS"
...
COCO_ANN_PATH="./"$DATA"/"$DATASET"/annotations/sar_rarp50_"$TEST_FOLD".json"
...
CHECKPOINT="/home/jclyons/endovis/miccai2025/LEMIS/data/LED/pretrained_models/k400_16.pyth"
